document.getElementById('check_volumes').addEventListener('click', function() {
    ...
    resultText += canFillCube ? "Кубическая ёмкость может быть заполнена.\n" : "Кубическая ёмкость не может быть заполнена.\n";
    resultText += canFillCylinder ? "Цилиндрическая ёмкость может быть заполнена.\n" : "Цилиндрическая ёмкость не может быть заполнена.\n";
